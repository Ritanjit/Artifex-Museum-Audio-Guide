...
export const Footer: React.FC = () => {
  return (
    <footer className="z-50 bg-neutral-900 py-10 text-amber-50">
      <div className="container mx-auto px-20">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-8 sm:gap-40">
          ...
          <div className="text-center md:text-left max-w-lg">
            <img src={horaiLogo} alt="Logo" className="h-30 w-auto mb-3 mx-auto md:mx-0" />
        ...
        {/* Copyright Section */}
        <div className="text-center text-gray-400 text-sm pb-10 sm:pb-0">
