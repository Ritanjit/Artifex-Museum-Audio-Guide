            ...
            <div className="relative z-10 px-4 sm:px-8 py-12">
                <div className="max-w-[1400px] mx-auto rounded-3xl bg-white dark:bg-zinc-900 shadow-2xl p-6 sm:p-10">
                    <article className="prose dark:prose-invert lg:prose-lg max-w-none space-y-16">
                        ...
                        {/* Intro */}
                        <section className="fade-in mx-20">
                            <p>
                        ...
                        {/* Mukha Cards Start */}
                        {/* Barmukha */}
                        <section className="fade-in bg-stone-100 dark:bg-zinc-800 p-6 rounded-2xl shadow-lg 
                        grid grid-cols-1 md:grid-cols-2 gap-6 items-center mx-17">
                            <div className="text-center">
                                <img
                                    src="/src/assets/barmukha.jpg"
                                    alt="Barmukha"
                                    className="w-full max-w-xs mx-auto rounded-xl border-2 
                            ...
                            <div className="mr-20">
                                <h2 className="text-2xl font-bold mb-5">1. Barmukha (Great Mask)</h2>
                                <p>
                        ...
                        grid grid-cols-1 md:grid-cols-2 gap-6 items-center mx-17">
                            ...
                            <div className="mr-20">
                                <h2 className="text-2xl font-bold mb-5">2. Lotokai-Mukha (Hanging/Animated Mask)</h2>
                                <p>
                        ...
                        grid grid-cols-1 md:grid-cols-2 gap-6 items-center mx-17">
                            ...
                            <div className="mr-20">
                                <h2 className="text-2xl font-bold mb-5">3. Mukh-Mukha (Face Mask)</h2>
                                <p>
                        ...
                        <div className="mt-16 text-center fade-in">
                            <Link
                                ...
                                font-semibold px-8 py-3 rounded-full shadow-lg hover:scale-101 transition-all duration-300"
                                onClick={() => {
